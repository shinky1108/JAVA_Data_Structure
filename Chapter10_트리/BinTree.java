...
public class BinTree<K, V> {
	...
	// 생성자 
	// 비교자로 키 값을 비교 
	public BinTree(Comparator<? super K> c) { // 인수로 비교자를 전달받는 생성자 
		this();
		comparator = c;
	}
	
	// 두 키 값을 비교 
	// key1을 Comparable<K> 인터페이스형으로 형변환하고 compareTo 메서드를 호출하여 key2와 비교함 
