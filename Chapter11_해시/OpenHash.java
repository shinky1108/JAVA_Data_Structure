...
// 충돌 해결 방법 두번째 : 오픈 주소법 
// 재해시를 수행하여 비어 있는 버킷을 찾아내는 방법으로, 닫힌 해시법이라고도 함 
// 예를 들어 18 % 13 = 5 에 넣으려고 하는데 있으면 => (18+1) % 13 => 6 이런식으로 재해시를 실행함 
// 삭제할 때 재해시를 하기 때문에 삭제하려는 해시값을 가진 값이 다른 인덱스에 저장되어 있을 수도 있으므로 구분하여야 함 
